...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RunStepDetailsToolCallsFunctionObjectFunction', function() {
      beforeEach(function() {
        instance = new OpenAiApi.RunStepDetailsToolCallsFunctionObjectFunction();
      });

      it('should create an instance of RunStepDetailsToolCallsFunctionObjectFunction', function() {
        // TODO: update the code to test RunStepDetailsToolCallsFunctionObjectFunction
        expect(instance).to.be.a(OpenAiApi.RunStepDetailsToolCallsFunctionObjectFunction);
      });
