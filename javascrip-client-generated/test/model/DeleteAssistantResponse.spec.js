...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeleteAssistantResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.DeleteAssistantResponse();
      });

      it('should create an instance of DeleteAssistantResponse', function() {
        // TODO: update the code to test DeleteAssistantResponse
        expect(instance).to.be.a(OpenAiApi.DeleteAssistantResponse);
      });
