...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeleteModelResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.DeleteModelResponse();
      });

      it('should create an instance of DeleteModelResponse', function() {
        // TODO: update the code to test DeleteModelResponse
        expect(instance).to.be.a(OpenAiApi.DeleteModelResponse);
      });
