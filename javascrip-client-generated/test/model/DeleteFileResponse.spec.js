...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeleteFileResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.DeleteFileResponse();
      });

      it('should create an instance of DeleteFileResponse', function() {
        // TODO: update the code to test DeleteFileResponse
        expect(instance).to.be.a(OpenAiApi.DeleteFileResponse);
      });
