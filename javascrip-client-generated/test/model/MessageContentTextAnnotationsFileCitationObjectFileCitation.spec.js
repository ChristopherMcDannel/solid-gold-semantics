...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageContentTextAnnotationsFileCitationObjectFileCitation', function() {
      beforeEach(function() {
        instance = new OpenAiApi.MessageContentTextAnnotationsFileCitationObjectFileCitation();
      });

      it('should create an instance of MessageContentTextAnnotationsFileCitationObjectFileCitation', function() {
        // TODO: update the code to test MessageContentTextAnnotationsFileCitationObjectFileCitation
        expect(instance).to.be.a(OpenAiApi.MessageContentTextAnnotationsFileCitationObjectFileCitation);
      });
