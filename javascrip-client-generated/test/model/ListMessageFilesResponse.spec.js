...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListMessageFilesResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ListMessageFilesResponse();
      });

      it('should create an instance of ListMessageFilesResponse', function() {
        // TODO: update the code to test ListMessageFilesResponse
        expect(instance).to.be.a(OpenAiApi.ListMessageFilesResponse);
      });
