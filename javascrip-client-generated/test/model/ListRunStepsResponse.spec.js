...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListRunStepsResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ListRunStepsResponse();
      });

      it('should create an instance of ListRunStepsResponse', function() {
        // TODO: update the code to test ListRunStepsResponse
        expect(instance).to.be.a(OpenAiApi.ListRunStepsResponse);
      });
