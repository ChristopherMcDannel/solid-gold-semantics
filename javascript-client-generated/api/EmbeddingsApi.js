...
export class EmbeddingsApi {
    ...
    */
     ...
     * @callback moduleapi/EmbeddingsApi~createEmbeddingCallback
     ...
     * @param {module:model/CreateEmbeddingRequest} body 
     ...
     */
    createEmbedding(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createEmbedding");
      }
