...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateChatCompletionStreamResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateChatCompletionStreamResponse();
      });

      it('should create an instance of CreateChatCompletionStreamResponse', function() {
        // TODO: update the code to test CreateChatCompletionStreamResponse
        expect(instance).to.be.a(OpenAiApi.CreateChatCompletionStreamResponse);
      });
