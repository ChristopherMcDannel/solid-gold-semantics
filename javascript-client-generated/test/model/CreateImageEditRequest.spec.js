...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateImageEditRequest', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateImageEditRequest();
      });

      it('should create an instance of CreateImageEditRequest', function() {
        // TODO: update the code to test CreateImageEditRequest
        expect(instance).to.be.a(OpenAiApi.CreateImageEditRequest);
      });
