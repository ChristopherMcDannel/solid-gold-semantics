...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateModerationRequest', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateModerationRequest();
      });

      it('should create an instance of CreateModerationRequest', function() {
        // TODO: update the code to test CreateModerationRequest
        expect(instance).to.be.a(OpenAiApi.CreateModerationRequest);
      });
