...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateModerationResponseCategoryScores', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateModerationResponseCategoryScores();
      });

      it('should create an instance of CreateModerationResponseCategoryScores', function() {
        // TODO: update the code to test CreateModerationResponseCategoryScores
        expect(instance).to.be.a(OpenAiApi.CreateModerationResponseCategoryScores);
      });
