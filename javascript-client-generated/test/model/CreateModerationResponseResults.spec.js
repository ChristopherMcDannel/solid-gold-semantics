...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateModerationResponseResults', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateModerationResponseResults();
      });

      it('should create an instance of CreateModerationResponseResults', function() {
        // TODO: update the code to test CreateModerationResponseResults
        expect(instance).to.be.a(OpenAiApi.CreateModerationResponseResults);
      });
