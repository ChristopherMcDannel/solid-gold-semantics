...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RunStepDetailsToolCallsCodeObjectCodeInterpreter', function() {
      beforeEach(function() {
        instance = new OpenAiApi.RunStepDetailsToolCallsCodeObjectCodeInterpreter();
      });

      it('should create an instance of RunStepDetailsToolCallsCodeObjectCodeInterpreter', function() {
        // TODO: update the code to test RunStepDetailsToolCallsCodeObjectCodeInterpreter
        expect(instance).to.be.a(OpenAiApi.RunStepDetailsToolCallsCodeObjectCodeInterpreter);
      });
