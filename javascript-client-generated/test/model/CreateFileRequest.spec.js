...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateFileRequest', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateFileRequest();
      });

      it('should create an instance of CreateFileRequest', function() {
        // TODO: update the code to test CreateFileRequest
        expect(instance).to.be.a(OpenAiApi.CreateFileRequest);
      });
