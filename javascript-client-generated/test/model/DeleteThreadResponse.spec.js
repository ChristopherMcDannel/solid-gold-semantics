...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeleteThreadResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.DeleteThreadResponse();
      });

      it('should create an instance of DeleteThreadResponse', function() {
        // TODO: update the code to test DeleteThreadResponse
        expect(instance).to.be.a(OpenAiApi.DeleteThreadResponse);
      });
