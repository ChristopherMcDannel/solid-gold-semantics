...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChatCompletionRequestFunctionMessage', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ChatCompletionRequestFunctionMessage();
      });

      it('should create an instance of ChatCompletionRequestFunctionMessage', function() {
        // TODO: update the code to test ChatCompletionRequestFunctionMessage
        expect(instance).to.be.a(OpenAiApi.ChatCompletionRequestFunctionMessage);
      });
