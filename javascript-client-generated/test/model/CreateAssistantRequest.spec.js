...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateAssistantRequest', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateAssistantRequest();
      });

      it('should create an instance of CreateAssistantRequest', function() {
        // TODO: update the code to test CreateAssistantRequest
        expect(instance).to.be.a(OpenAiApi.CreateAssistantRequest);
      });
