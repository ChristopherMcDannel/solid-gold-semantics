...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateImageVariationRequest', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateImageVariationRequest();
      });

      it('should create an instance of CreateImageVariationRequest', function() {
        // TODO: update the code to test CreateImageVariationRequest
        expect(instance).to.be.a(OpenAiApi.CreateImageVariationRequest);
      });
