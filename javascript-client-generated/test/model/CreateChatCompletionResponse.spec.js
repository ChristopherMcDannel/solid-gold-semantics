...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateChatCompletionResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateChatCompletionResponse();
      });

      it('should create an instance of CreateChatCompletionResponse', function() {
        // TODO: update the code to test CreateChatCompletionResponse
        expect(instance).to.be.a(OpenAiApi.CreateChatCompletionResponse);
      });
