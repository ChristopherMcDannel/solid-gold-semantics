...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChatCompletionStreamResponseDelta', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ChatCompletionStreamResponseDelta();
      });

      it('should create an instance of ChatCompletionStreamResponseDelta', function() {
        // TODO: update the code to test ChatCompletionStreamResponseDelta
        expect(instance).to.be.a(OpenAiApi.ChatCompletionStreamResponseDelta);
      });
