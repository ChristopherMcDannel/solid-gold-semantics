...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateCompletionResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateCompletionResponse();
      });

      it('should create an instance of CreateCompletionResponse', function() {
        // TODO: update the code to test CreateCompletionResponse
        expect(instance).to.be.a(OpenAiApi.CreateCompletionResponse);
      });
