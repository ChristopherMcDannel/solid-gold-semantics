...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageContentTextObjectText', function() {
      beforeEach(function() {
        instance = new OpenAiApi.MessageContentTextObjectText();
      });

      it('should create an instance of MessageContentTextObjectText', function() {
        // TODO: update the code to test MessageContentTextObjectText
        expect(instance).to.be.a(OpenAiApi.MessageContentTextObjectText);
      });
