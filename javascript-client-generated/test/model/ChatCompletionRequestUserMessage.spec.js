...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChatCompletionRequestUserMessage', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ChatCompletionRequestUserMessage();
      });

      it('should create an instance of ChatCompletionRequestUserMessage', function() {
        // TODO: update the code to test ChatCompletionRequestUserMessage
        expect(instance).to.be.a(OpenAiApi.ChatCompletionRequestUserMessage);
      });
