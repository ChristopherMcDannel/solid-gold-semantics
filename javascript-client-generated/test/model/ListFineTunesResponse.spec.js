...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListFineTunesResponse', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ListFineTunesResponse();
      });

      it('should create an instance of ListFineTunesResponse', function() {
        // TODO: update the code to test ListFineTunesResponse
        expect(instance).to.be.a(OpenAiApi.ListFineTunesResponse);
      });
