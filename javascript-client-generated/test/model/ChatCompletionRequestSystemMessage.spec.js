...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChatCompletionRequestSystemMessage', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ChatCompletionRequestSystemMessage();
      });

      it('should create an instance of ChatCompletionRequestSystemMessage', function() {
        // TODO: update the code to test ChatCompletionRequestSystemMessage
        expect(instance).to.be.a(OpenAiApi.ChatCompletionRequestSystemMessage);
      });
