...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChatCompletionRequestAssistantMessage', function() {
      beforeEach(function() {
        instance = new OpenAiApi.ChatCompletionRequestAssistantMessage();
      });

      it('should create an instance of ChatCompletionRequestAssistantMessage', function() {
        // TODO: update the code to test ChatCompletionRequestAssistantMessage
        expect(instance).to.be.a(OpenAiApi.ChatCompletionRequestAssistantMessage);
      });
