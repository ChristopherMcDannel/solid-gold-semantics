...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateChatCompletionFunctionResponseChoices', function() {
      beforeEach(function() {
        instance = new OpenAiApi.CreateChatCompletionFunctionResponseChoices();
      });

      it('should create an instance of CreateChatCompletionFunctionResponseChoices', function() {
        // TODO: update the code to test CreateChatCompletionFunctionResponseChoices
        expect(instance).to.be.a(OpenAiApi.CreateChatCompletionFunctionResponseChoices);
      });
